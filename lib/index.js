...
module.exports = (function () {
  ...
  let obtainContextInfo = function* (tenantDomain, credentials) {
    ...
    let type3Response = yield this.sendType3MessageAsync.call(this, type1Response, credentials, options);
 ...
 */
  let ensureContextInfo = function* (tenantDomain, credentials, force) {
    ...
    return this.contextInfo = yield this.obtainContextInfoAsync.call(this, tenantDomain, credentials);
  };
 ...
 */
  let authenticate = function* (tenantDomain, workstation, domain, username, password) {
    ...
    yield self.ensureContextInfoAsync.call(self, tenantDomain, credentials);

    let fnMethod = function (options, callback) {
      return self.ensureContextInfoAsync.call(self, tenantDomain, credentials)
        ...
        .then(function (type1Response) {
          return self.sendType3MessageAsync.call(self, type1Response, credentials, options);
        })
    ...
    return {
      ...
      ensureContextInfoAsync: self.ensureContextInfoAsync.bind(self, tenantDomain, credentials),
      ntlm: ntlm,
      request: defaultSPRequest,
      requestAsync: Promise.promisify(defaultSPRequest),
      sendType1Message: sendType1Message.bind(self),
      sendType1MessageAsync: self.sendType1MessageAsync.bind(self),
      sendType3Message: sendType3Message.bind(self),
      sendType3MessageAsync: self.sendType3MessageAsync.bind(self),
